    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ route('update.subcategory', $data->id) }}" method="POST" class="forms-sample">
                @csrf

              <div class="form-group">
                <label for="subcategory_en">SubCategory Eng</label>
                <input type="text" name="subcategory_en" class="form-control" value="{{ $data->subcategory_en }}">
              ...
              <div class="form-group">
                ...
                <input type="text" name="subcategory_sr" class="form-control" value="{{ $data->subcategory_sr }}">
